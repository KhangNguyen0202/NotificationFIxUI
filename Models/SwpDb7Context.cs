...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__account__B9BE370F7A10F7E8");

            entity.ToTable("account");

            entity.HasIndex(e => e.UserEmail, "UQ__account__B0FBA212FB6A8423").IsUnique();

            entity.HasIndex(e => e.Username, "UQ__account__F3DBC572A6EC511B").IsUnique();
        ...
        {
            entity.HasKey(e => e.AchievementId).HasName("PK__achievem__3C492E835780A393");
        ...
        {
            entity.HasKey(e => e.ChapterId).HasName("PK__chapter__745EFE87D19079A2");
        ...
        {
            entity.HasKey(e => e.ConversationId).HasName("PK__chatbot___311E7E9AEC8496AF");
        ...
        {
            entity.HasKey(e => e.CourseId).HasName("PK__course__8F1EF7AE07C5B638");
            ...
            entity.HasMany(d => d.CourseCategories).WithMany(p => p.Courses)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("CourseId", "CourseCategoryId").HasName("PK__course_c__10F92220429FE1F1");
        ...
        {
            entity.HasKey(e => e.CourseCategoryId).HasName("PK__course_c__FE7D58E847352156");
        ...
        {
            entity.HasKey(e => e.EnrollmentId).HasName("PK__enrollme__6D24AA7AAD37BFF4");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__feedback__7A6B2B8CB62ED87B");
        ...
        {
            entity.HasKey(e => e.LessonId).HasName("PK__lesson__6421F7BE9DCBD89D");
        ...
        {
            entity.HasKey(e => e.LessonTypeId).HasName("PK__lesson_t__F5960D1E7081B331");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__notifica__E059842F67B0CBA4");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__payment__ED1FC9EA3A9C6C8A");
        ...
        {
            entity.HasKey(e => e.UserRole).HasName("PK__role__68057FEC936745FF");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__status__3683B531A109A93F");
        ...
        {
            entity.HasKey(e => new { e.UserId, e.AchievementId }).HasName("PK__user_ach__9A7AA5E7462336C7");
